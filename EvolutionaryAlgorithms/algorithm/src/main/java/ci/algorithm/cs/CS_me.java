...
public class CS_me extends EvolutionaryAlgorithm{
	...
	public CS_me(Problem problem, long maxFunctionEvaluations, int populationSize,double Pa,double beta) {
	...
	public void run() {
		...
		for(int q=0;q<maxFunctionEvaluations;q++) {
			...
			{
				System.out.println(q*populationSize*2);
				break;
			}*/
    ...
    public static void main(String[] args) {
		//Problem problem=new CEC2005(10,100);
		//Problem problem=new Ackley(10);
		Problem problem =new CEC2005(2,30);



        CS_me cs = new CS_me(problem, 5000, 30,0.25,1.5);
        cs.run();
