...
public class Benchmark {
  ...
  public void runTest(int func_num)  {
    if (func_num == 0) {
      ...
      String file_test = "H:\\jMetal\\jMetal\\EvolutionaryAlgorithms\\Problems\\src\\main\\java\\cn\\edu\\fafu" +
              "\\ci\\problem\\cec2005\\testData\\test_data_func" + func_num + ".txt";
