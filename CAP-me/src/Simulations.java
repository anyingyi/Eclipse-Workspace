...
public class Simulations {
	...
	public static String getParaSetting() {
		String str = methodType + "-" + encodingType + "-";
	...
	private static EMethodType methodType = EMethodType.RANDOM;
	public static EEncodingType encodingType = EEncodingType.ORDER;
	...
	//Parameter for GA
	public static int tour=10;
	public static final int  top=2;
	public static final int popSize=100;
	public static final int offs = 20;
	public static final int learningNum = 10;

	
	
	//Parameter for ACO
	public static double alpha_aco=1.0;
	public static double beta=0;
	public static double rho=0.1;
	public static double pherMax=50;
	public static double pherMin=1;
	public static final double addPher = 1;
