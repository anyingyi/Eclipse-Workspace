...
public abstract class Solution implements Comparable<Solution> {
	...
	protected List<Integer>[] order = new List[1];
	...
	public static Solution make() {
		if (Simulations.encodingType == EEncodingType.ORDER) {
			...
			return new SolutionOrder_Int(); //Call the construction of your implementation
		} else if (Simulations.encodingType == EEncodingType.ORDER_BIT){
			return new SolutionOrder_Bit(); //Call the construction of your implementation
		} else {
	...
	public abstract  Solution[] makeChild(Solution p1,Solution p2);
	...
	public static void main(String[] args) {
    	...
    	//Method
    	Solution best=Methods.basicACO();
